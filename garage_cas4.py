...
image1 = fonctions.findImage(emetteur, mur_gauche)
print('Coordonnées de l\'image1 (logiciel) =' + image1.toString())
print('\n')
#Coordoonées de l'image2:
image2 = fonctions.findImage(image1, mur_haut)
print('Coordonnées de l\'image 2 (logiciel)= ' + image2.toString())
print('\n')
#Coordoonées du point Pr2
Pr2 = fonctions.findIntersection(mur_haut.getStart(), mur_haut.getEnd(), image2, recepteur.getPosition())
print('Coordonné de l\'intersection Pr2 (logiciel) = ' + Pr2.toString())
print('\n')
#Coordoonées du point PR1
Pr1 = fonctions.findIntersection(mur_gauche.getStart(), mur_gauche.getEnd(), image1, Pr2)
...
# Calcul de l'angle d'incidence
thetaI = fonctions.findThetaI(Pr1,emetteur.getPosition(), mur_gauche)
...
Reflexion1 = coeff_reflexion(emetteur, Pr1, mur_gauche)
...
#thetaI
thetaI = fonctions.findThetaI(recepteur.getPosition(),image2, mur_haut)
...
#coefficient de réflexion
Reflexion2 = coeff_reflexion(recepteur, image2, mur_haut)
...
E3 = (sqrt(60 * emetteur.getGain() * emetteur.getPower())* cmath.exp(-1 * complex(0,1) * (2*(pi)/L) * d))/ d
E3 = Tm*Reflexion1*Reflexion2*E3
print('Champ perçu par l\'onde (logiciel) = ' + str(E3*10**4) + "*10^-4")